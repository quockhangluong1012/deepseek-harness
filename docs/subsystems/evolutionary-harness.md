...
Source: [`specs/evolutionary-harness-v11-deep-research.md`](../../specs/evolutionary-harness-v11-deep-research.md)
...
The [evolution group map](../../packages/evolution/README.md#packages) owns the complete package list — every package's role and `ctx` key — and the generated [Cordis API](#cordis-surface) below owns their service, event, and Remote surfaces. This reference names no package list of its own so the two cannot drift apart.
