---
description: "记录 PR #4320 最终树中 Session V4 的持久化类型和来源证据。"
...
检查 V4 完整的持久化类型及其版本化头部。本快照来自 PR #4320 的最终树；V3 页面记录该 PR 的初始树。它保留已接受的 V4 基线，不把后续兼容扩展并入这个历史检查点。
...
V4 来源是 PR #4320 在 `release/session-log-v4` 上的最终树。该 PR 初始树仍是 V3；其最终树包含 V4 写入格式。V4 声明取自已接受的 `2026-09-16-session-format-v4` 架构及在该转换前已接受的 `2026-09-14-workspace-changes-event` 架构，合并后的 62 个根摘要与 [V4 最终检查点](../finalized/v4.json)一致。

声明来自该 PR 树中的 `packages/core/session/src/types.ts`、`packages/session/session-persistence-jsonl/src/format.ts` 及一方 `SessionEventMap` 声明。

<a id="characteristics"></a>
## 格式特征

V4 在 Session 头部中记录 `version: 4`。它采用 V4 原生 tool-role 消息和 producer-owned 来源，并保留 V3 到 V4 的物理记录编码。已记录的 turn 结束原因不含 V5 新增的 `max-steps` 变体。

本页面记录已接受的 V4 基线，不定义物理解码或 V3 转换规则。请参阅 [V3 到 V4 迁移规范](../../../packages/session/session-format-v3-to-v4/README.zh.md#v3-to-v4-specification)了解这些行为。

<a id="declaration"></a>
## 声明

完整类型位于 [v4.schema.json](v4.schema.json)。
...
[完整机器目录](v4.schema.json)包含 62 个根类型和 582 种可达类型。摘要包含所有引用字段；源码名称和路径描述所选的历史源码树。
...
| `start` | 必需 | `number` |
| `target` | 必需 | [`event:agent/inbox/spliced.data.target`](#persistence-type-eventagentinboxspliceddatatarget) |
...
[`event:agent/inbox/spliced.data.inserted.item`](#persistence-type-eventagentinboxspliceddatainserteditem) 的数组。
...
| `id` | 必需 | `string` |
| `role` | 必需 | `"user"` |
| `source` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source`](#persistence-type-eventagentinboxspliceddatainserteditemsource) |
...
[`event:agent/inbox/spliced.data.inserted.item.content.item`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitem) 的数组。
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `attachment` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-5.attachment`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5attachment) |
| `offloaded` | 可选 | `true` |
| `type` | 必需 | `"image"` |
...
| `bytes` | 必需 | `number` |
| `height` | 必需 | `number` |
| `mediaType` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-5.attachment.mediaType`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5attachmentmediatype) |
| `name` | 可选 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `attachment` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-6.attachment`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-6attachment) |
| `type` | 必需 | `"file"` |
...
[`event:agent/inbox/spliced.data.inserted.item.source.variant-79.changes.item`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-79changesitem) 的数组。
...
| `capturedThroughSeq` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-86.references.item.capturedThroughSeq`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86referencesitemcapturedthroughseq) |
...
[`event:agent/inbox/spliced.data.inserted.item.source.variant-87.sections.item`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-87sectionsitem) 的数组。
...
|---|---|---|
| `id` | 必需 | `string` |
| `outcome` | 必需 | [`event:approval/decided.data.outcome`](#persistence-type-eventapprovaldecideddataoutcome) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `policy` | 必需 | [`event:approval/policy.data.policy`](#persistence-type-eventapprovalpolicydatapolicy) |
...
[`event:assistant/attempt.data.stream.item`](#persistence-type-eventassistantattemptdatastreamitem) 的数组。
...
| `dt` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `id` | 必需 | `string` |
| `index` | 必需 | `number` |
| `name` | 可选 | `string` |
| `time0` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `chunk` | 必需 | [`event:assistant/attempt.data.stream.item.variant-1.chunk`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunk) |
| `time` | 必需 | `number` |
| `type` | 必需 | `"chunk"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `block` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.content.item`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitem) |
| `index` | 必需 | `number` |
| `type` | 必需 | `"block-end"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `blockType` | 必需 | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-2.blockType`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-2blocktype) |
| `index` | 必需 | `number` |
| `type` | 必需 | `"block-start"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `reason` | 必需 | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.reason`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5reason) |
| `replayState` | 可选 | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.replayState`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5replaystate) |
| `type` | 必需 | `"finish"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `failure` | 必需 | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.reason.variant-0.failure`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5reasonvariant-0failure) |
| `kind` | 必需 | `"aborted"` |
...
|---|---|---|
| `type` | 必需 | `"usage"` |
| `usage` | 必需 | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-6.usage`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-6usage) |
...
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `surfaceOp` | 必需 | [`event:assistant/message.surfaceOp`](#persistence-type-eventassistantmessagesurfaceop) |
| `time` | 必需 | `number` |
...
|---|---|---|
| `interrupted` | 可选 | `true` |
| `message` | 必需 | [`event:assistant/message.data.message`](#persistence-type-eventassistantmessagedatamessage) |
| `step` | 必需 | `number` |
| `stream` | 必需 | [`event:assistant/attempt.data.stream`](#persistence-type-eventassistantattemptdatastream) |
| `turn` | 必需 | `number` |
| `usage` | 可选 | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-6.usage`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-6usage) |
...
| `id` | 必需 | `string` |
| `role` | 必需 | `"assistant"` |
| `source` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-60`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-60) |
...
| `commandId` | 必需 | `string` |
| `name` | 必需 | `string` |
| `source` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-75`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-75) |
...
| `error` | 可选 | `string` |
| `sourceCommandId` | 可选 | `string` |
| `turn` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-86.references.item.capturedThroughSeq`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86referencesitemcapturedthroughseq) |
...
| `shadowedSeqs` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
...
[`event:deliverables/presented.data.files.item`](#persistence-type-eventdeliverablespresenteddatafilesitem) 的数组。
...
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `surfaceOp` | 必需 | [`event:assistant/message.surfaceOp`](#persistence-type-eventassistantmessagesurfaceop) |
| `time` | 必需 | `number` |
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`event:developer/message.data.message`](#persistence-type-eventdevelopermessagedatamessage) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `item` | 必需 | [`event:feedback/message-put.data.item`](#persistence-type-eventfeedbackmessage-putdataitem) |
| `sessionId` | 必需 | `string` |
...
| `messageId` | 必需 | `string` |
| `note` | 可选 | `string` |
| `rating` | 必需 | [`event:feedback/message-put.data.item.rating`](#persistence-type-eventfeedbackmessage-putdataitemrating) |
| `updatedAt` | 必需 | `number` |
| `version` | 必需 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:feedback/record.data`](#persistence-type-eventfeedbackrecorddata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:goal/change.data`](#persistence-type-eventgoalchangedata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"goal/change"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `cleared` | 必需 | [`event:goal/change.data.variant-0.cleared`](#persistence-type-eventgoalchangedatavariant-0cleared) |
| `clearedAt` | 必需 | `number` |
| `kind` | 必需 | `"goal/change"` |
| `operation` | 必需 | `"clear"` |
| `version` | 必需 | `1` |
...
|---|---|---|
| `createdAt` | 必需 | `number` |
| `goal` | 必需 | [`event:goal/change.data.variant-1.goal`](#persistence-type-eventgoalchangedatavariant-1goal) |
| `kind` | 必需 | `"goal/change"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `blockedReason` | 可选 | [`event:goal/change.data.variant-1.goal.blockedReason`](#persistence-type-eventgoalchangedatavariant-1goalblockedreason) |
| `id` | 必需 | `string` |
| `maxGoalRounds` | 必需 | `number` |
| `objective` | 必需 | `string` |
| `phase` | 必需 | [`event:goal/change.data.variant-1.goal.phase`](#persistence-type-eventgoalchangedatavariant-1goalphase) |
| `revision` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `dialect` | 必需 | [`event:hook/invoked.data.dialect`](#persistence-type-eventhookinvokeddatadialect) |
| `handlerId` | 必需 | `string` |
| `matcher` | 可选 | `string` |
| `point` | 必需 | `string` |
| `turn` | 必需 | `number` |
...
[`event:image/offload.data.targets.item`](#persistence-type-eventimageoffloaddatatargetsitem) 的数组。
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `imageIndexes` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `seq` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:llm/retry.data`](#persistence-type-eventllmretrydata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"llm/retry"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:llm/retry-started.data`](#persistence-type-eventllmretry-starteddata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:model/selection.data`](#persistence-type-eventmodelselectiondata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:request/context.data`](#persistence-type-eventrequestcontextdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `header` | 必需 | [`event:request/header.data.header`](#persistence-type-eventrequestheaderdataheader) |
| `reason` | 必需 | [`event:request/header.data.reason`](#persistence-type-eventrequestheaderdatareason) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `adapterDefaults` | 可选 | [`event:request/header.data.header.adapterDefaults`](#persistence-type-eventrequestheaderdataheaderadapterdefaults) |
| `config` | 必需 | [`event:request/header.data.header.config`](#persistence-type-eventrequestheaderdataheaderconfig) |
| `system` | 可选 | `never` |
...
[`event:request/header.data.header.tools.item`](#persistence-type-eventrequestheaderdataheadertoolsitem) 的数组。
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `mode` | 必需 | [`event:sandbox/mode.data.mode`](#persistence-type-eventsandboxmodedatamode) |
| `source` | 可选 | `"delegation"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:schedule/change.data`](#persistence-type-eventschedulechangedata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
|---|---|---|
| `operation` | 必需 | `"create"` |
| `schedule` | 必需 | [`event:schedule/change.data.variant-3.schedule`](#persistence-type-eventschedulechangedatavariant-3schedule) |
| `version` | 必需 | `1` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:session/title.data`](#persistence-type-eventsessiontitledata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:session/title-llm-request.data`](#persistence-type-eventsessiontitle-llm-requestdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
|---|---|---|
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `messages` | 必需 | [`event:session/title-llm-request.data.messages`](#persistence-type-eventsessiontitle-llm-requestdatamessages) |
| `route` | 必需 | [`event:session/title.data.source.variant-0.model`](#persistence-type-eventsessiontitledatasourcevariant-0model) |
| `system` | 必需 | `string` |
...
[`event:session/title-llm-request.data.messages.item`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitem) 的数组。
...
| `isError` | 可选 | `boolean` |
| `role` | 必需 | `"tool"` |
| `source` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-80`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-80) |
...
| `id` | 必需 | `string` |
| `role` | 必需 | `"system"` |
| `source` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-69`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-69) |
...
|---|---|---|
| `messageSeqs` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `source` | 必需 | [`event:session/title.data.source`](#persistence-type-eventsessiontitledatasource) |
| `title` | 必需 | `string` |
...
|---|---|---|
| `kind` | 必需 | `"provider"` |
| `model` | 可选 | [`event:session/title.data.source.variant-0.model`](#persistence-type-eventsessiontitledatasourcevariant-0model) |
| `provider` | 必需 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:subagent/catalog.data`](#persistence-type-eventsubagentcatalogdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:subagent/descriptor.data`](#persistence-type-eventsubagentdescriptordata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| `persona` | 可选 | `string` |
| `provider` | 必需 | `string` |
| `toolFilter` | 可选 | [`event:subagent/descriptor.data.variant-0.toolFilter`](#persistence-type-eventsubagentdescriptordatavariant-0toolfilter) |
| `version` | 必需 | `number` |
...
[`event:session/title.data.source.variant-0.model`](#persistence-type-eventsessiontitledatasourcevariant-0model) 的数组。
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `message` | 必需 | [`event:session/title-llm-request.data.messages.item.variant-4`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-4) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `member` | 必需 | [`event:team/member.data.member`](#persistence-type-eventteammemberdatamember) |
| `teamId` | 必需 | `string` |
| `version` | 必需 | `2` |
...
| `id` | 必需 | `string` |
| `name` | 必需 | `string` |
| `phase` | 必需 | [`event:team/member.data.member.phase`](#persistence-type-eventteammemberdatamemberphase) |
| `provider` | 必需 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `message` | 必需 | [`event:team/message/queued.data.message`](#persistence-type-eventteammessagequeueddatamessage) |
| `teamId` | 必需 | `string` |
| `version` | 必需 | `2` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `task` | 必需 | [`event:team/task.data.task`](#persistence-type-eventteamtaskdatatask) |
| `teamId` | 必需 | `string` |
| `version` | 必需 | `2` |
...
| `ownerId` | 可选 | `string` |
| `revision` | 必需 | `number` |
| `status` | 必需 | [`event:team/task.data.task.status`](#persistence-type-eventteamtaskdatataskstatus) |
| `subject` | 必需 | `string` |
...
[`event:todo/write.data.todos.item`](#persistence-type-eventtodowritedatatodositem) 的数组。
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:tool-workflow/agent-end.data`](#persistence-type-eventtool-workflowagent-enddata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `outcome` | 必需 | [`event:tool-workflow/agent-end.data.outcome`](#persistence-type-eventtool-workflowagent-enddataoutcome) |
| `runId` | 必需 | `string` |
| `seq` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:tool-workflow/agent-start.data`](#persistence-type-eventtool-workflowagent-startdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:tool-workflow/run-end.data`](#persistence-type-eventtool-workflowrun-enddata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
|---|---|---|
| `runId` | 必需 | `string` |
| `stopReason` | 必需 | [`event:tool-workflow/run-end.data.stopReason`](#persistence-type-eventtool-workflowrun-enddatastopreason) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:tool-workflow/run-start.data`](#persistence-type-eventtool-workflowrun-startdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:tool/ptc-dispatch.data`](#persistence-type-eventtoolptc-dispatchdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:tool/ptc-dispatch-start.data`](#persistence-type-eventtoolptc-dispatch-startdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
|---|---|---|
| `error` | 可选 | [`event:tool/ptc-dispatch.data.error`](#persistence-type-eventtoolptc-dispatchdataerror) |
| `message` | 必需 | [`event:session/title-llm-request.data.messages.item.variant-0`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-0) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `reason` | 必需 | [`event:turn/end.data.reason`](#persistence-type-eventturnenddatareason) |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `error` | 必需 | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.reason.variant-0.failure`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5reasonvariant-0failure) |
| `kind` | 必需 | `"error"` |
...
|---|---|---|
| `kind` | 必需 | `"aborted"` |
| `reason` | 必需 | [`event:turn/end.data.reason.variant-6.reason`](#persistence-type-eventturnenddatareasonvariant-6reason) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:agent/inbox/spliced.data.inserted.item`](#persistence-type-eventagentinboxspliceddatainserteditem) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `surfaceOp` | 必需 | [`event:assistant/message.surfaceOp`](#persistence-type-eventassistantmessagesurfaceop) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:web/deepseek-search-llm-request.data`](#persistence-type-eventwebdeepseek-search-llm-requestdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 位置 | 存在性 | 类型 |
|---|---|---|
| 0 | 必需 | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-1`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-1) |
...
本快照的根摘要与已接受的 V4 最终检查点一致。`pnpm run verify-persistence-formats` 离线校验该声明与完整架构；它不重放历史日志，也不证明迁移安全。
