---
description: "Records the persistence types and source evidence for Session V4 in the final tree of PR #4320."
...
Inspect the complete V4 persistence types and versioned header. This snapshot records the final tree of PR #4320; the V3 page records that PR’s initial tree. It preserves the accepted V4 baseline and excludes later compatible additions from this historical checkpoint.
...
V4 comes from the final tree of PR #4320 on `release/session-log-v4`. The PR’s initial tree still wrote V3; its final tree contains the V4 writer format. The V4 declaration uses the accepted `2026-09-16-session-format-v4` schema plus the `2026-09-14-workspace-changes-event` schema accepted before that transition; the merged 62 root digests match the [V4 finalization checkpoint](../finalized/v4.json).

The declaration covers `packages/core/session/src/types.ts`, `packages/session/session-persistence-jsonl/src/format.ts`, and first-party `SessionEventMap` declarations from that PR tree.

<a id="characteristics"></a>
## Format characteristics

V4 records `version: 4` in the Session header. It uses native V4 tool-role messages and producer-owned sources while retaining V3-to-V4 physical row encoding. Its recorded turn-end reasons do not include the V5 `max-steps` variant.

This page records the accepted V4 baseline; it does not define physical decoding or V3 conversion. See the [V3-to-V4 migration specification](../../../packages/session/session-format-v3-to-v4/README.md#v3-to-v4-specification) for those behaviors.

<a id="declaration"></a>
## Declaration

The complete types are in [v4.schema.json](v4.schema.json).
...
The [complete machine inventory](v4.schema.json) contains 62 roots and 582 reachable types. Digests include all referenced fields; source names and paths describe the selected historical tree.
...
| `JsonlHeaderLine` | header | `18ee62b8900a4c3d046700f05d7a4d49d6cab2a660a020c87481d1603dd8bd4f` | [`JsonlHeaderLine`](#persistence-type-jsonlheaderline) |
...
| `SessionHeader` | header | `1a3440e3577382704d42a6263aa463504eb74c566734a55e9503a63efcd02445` | [`SessionHeader`](#persistence-type-sessionheader) |
...
| `target` | required | [`event:agent/inbox/spliced.data.target`](#persistence-type-eventagentinboxspliceddatatarget) |
...
Array of [`event:agent/inbox/spliced.data.inserted.item`](#persistence-type-eventagentinboxspliceddatainserteditem).

<a id="persistence-type-eventagentinboxspliceddatainserteditem"></a>

#### `event:agent/inbox/spliced.data.inserted.item`
...
| `id` | required | `string` |
| `role` | required | `"user"` |
| `source` | required | [`event:agent/inbox/spliced.data.inserted.item.source`](#persistence-type-eventagentinboxspliceddatainserteditemsource) |
...
Array of [`event:agent/inbox/spliced.data.inserted.item.content.item`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitem).

<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitem"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item`

SHA-256: `8064c03c87c357fd1575cb9395ce86e6dcbe2d275bf7717864a02cddf01827d5`

One of:

- [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-0`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-0)
- [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-1`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-1)
- [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-2`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-2)
- [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-3`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-3)
- [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-4`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-4)
- [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-5`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5)
- [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-6`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-6)

<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-0"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-0`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-1"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-1`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-2"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-2`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-3"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-3`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-4"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-4`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-5`

SHA-256: `12d5808fac1996b9b3c2afa806e03022252ba2d7b88f835862ae1896591f60c7`

| Property | Presence | Type |
|---|---|---|
| `attachment` | required | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-5.attachment`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5attachment) |
| `offloaded` | optional | `true` |
| `type` | required | `"image"` |

<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5attachment"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-5.attachment`
...
| `mediaType` | required | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-5.attachment.mediaType`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5attachmentmediatype) |
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5attachmentmediatype"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-5.attachment.mediaType`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-6"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-6`

SHA-256: `f2da0f27c1e6add59982c37b15e4a4912c5b33466859cce3b13d503600e24aef`

| Property | Presence | Type |
|---|---|---|
| `attachment` | required | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-6.attachment`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-6attachment) |
| `type` | required | `"file"` |

<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-6attachment"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-6.attachment`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsource"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source`
...
- [`event:agent/inbox/spliced.data.inserted.item.source.variant-69`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-69)
...
- [`event:agent/inbox/spliced.data.inserted.item.source.variant-75`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-75)
...
- [`event:agent/inbox/spliced.data.inserted.item.source.variant-79`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-79)
- [`event:agent/inbox/spliced.data.inserted.item.source.variant-80`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-80)
...
- [`event:agent/inbox/spliced.data.inserted.item.source.variant-86`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86)
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-69"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-69`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-75"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-75`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-79"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-79`
...
Array of [`event:agent/inbox/spliced.data.inserted.item.source.variant-79.changes.item`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-79changesitem).

<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-79changesitem"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-79.changes.item`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-80"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-80`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-86`
...
| `capturedThroughSeq` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-86.references.item.capturedThroughSeq`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86referencesitemcapturedthroughseq) |
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86referencesitemcapturedthroughseq"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-86.references.item.capturedThroughSeq`
...
Array of [`event:agent/inbox/spliced.data.inserted.item.source.variant-87.sections.item`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-87sectionsitem).

<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-87sectionsitem"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-87.sections.item`
...
<a id="persistence-type-eventagentinboxspliceddatatarget"></a>

#### `event:agent/inbox/spliced.data.target`
...
|---|---|---|
| `id` | required | `string` |
| `outcome` | required | [`event:approval/decided.data.outcome`](#persistence-type-eventapprovaldecideddataoutcome) |

<a id="persistence-type-eventapprovaldecideddataoutcome"></a>

#### `event:approval/decided.data.outcome`
...
| Property | Presence | Type |
|---|---|---|
| `policy` | required | [`event:approval/policy.data.policy`](#persistence-type-eventapprovalpolicydatapolicy) |
| `source` | optional | `"delegation"` |

<a id="persistence-type-eventapprovalpolicydatapolicy"></a>

#### `event:approval/policy.data.policy`
...
Array of [`event:assistant/attempt.data.stream.item`](#persistence-type-eventassistantattemptdatastreamitem).

<a id="persistence-type-eventassistantattemptdatastreamitem"></a>

#### `event:assistant/attempt.data.stream.item`
...
| `dt` | required | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `id` | required | `string` |
...
<a id="persistence-type-eventassistantattemptdatastreamitemvariant-0dt"></a>

#### `event:assistant/attempt.data.stream.item.variant-0.dt`
...
| Property | Presence | Type |
|---|---|---|
| `chunk` | required | [`event:assistant/attempt.data.stream.item.variant-1.chunk`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunk) |
| `time` | required | `number` |
| `type` | required | `"chunk"` |

<a id="persistence-type-eventassistantattemptdatastreamitemvariant-1chunk"></a>

#### `event:assistant/attempt.data.stream.item.variant-1.chunk`
...
| Property | Presence | Type |
|---|---|---|
| `block` | required | [`event:agent/inbox/spliced.data.inserted.item.content.item`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitem) |
| `index` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `blockType` | required | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-2.blockType`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-2blocktype) |
| `index` | required | `number` |
| `type` | required | `"block-start"` |

<a id="persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-2blocktype"></a>

#### `event:assistant/attempt.data.stream.item.variant-1.chunk.variant-2.blockType`
...
| Property | Presence | Type |
|---|---|---|
| `reason` | required | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.reason`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5reason) |
| `replayState` | optional | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.replayState`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5replaystate) |
| `type` | required | `"finish"` |

<a id="persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5reason"></a>

#### `event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.reason`
...
| Property | Presence | Type |
|---|---|---|
| `failure` | required | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.reason.variant-0.failure`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5reasonvariant-0failure) |
| `kind` | required | `"aborted"` |

<a id="persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5reasonvariant-0failure"></a>

#### `event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.reason.variant-0.failure`
...
<a id="persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5replaystate"></a>

#### `event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.replayState`
...
|---|---|---|
| `type` | required | `"usage"` |
| `usage` | required | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-6.usage`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-6usage) |

<a id="persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-6usage"></a>

#### `event:assistant/attempt.data.stream.item.variant-1.chunk.variant-6.usage`
...
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `surfaceOp` | required | [`event:assistant/message.surfaceOp`](#persistence-type-eventassistantmessagesurfaceop) |
| `time` | required | `number` |
...
| `message` | required | [`event:assistant/message.data.message`](#persistence-type-eventassistantmessagedatamessage) |
| `step` | required | `number` |
| `stream` | required | [`event:assistant/attempt.data.stream`](#persistence-type-eventassistantattemptdatastream) |
| `turn` | required | `number` |
| `usage` | optional | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-6.usage`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-6usage) |

<a id="persistence-type-eventassistantmessagedatamessage"></a>

#### `event:assistant/message.data.message`
...
| `source` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-60`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-60) |

<a id="persistence-type-eventassistantmessagesurfaceop"></a>

#### `event:assistant/message.surfaceOp`
...
- `"append"`
- [`event:assistant/message.surfaceOp.variant-0`](#persistence-type-eventassistantmessagesurfaceopvariant-0)

<a id="persistence-type-eventassistantmessagesurfaceopvariant-0"></a>

#### `event:assistant/message.surfaceOp.variant-0`
...
| `commandId` | required | `string` |
| `name` | required | `string` |
| `source` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-75`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-75) |
...
| `sourceCommandId` | optional | `string` |
| `turn` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-86.references.item.capturedThroughSeq`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86referencesitemcapturedthroughseq) |
...
| `shadowedSeqs` | required | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
...
Array of [`event:deliverables/presented.data.files.item`](#persistence-type-eventdeliverablespresenteddatafilesitem).

<a id="persistence-type-eventdeliverablespresenteddatafilesitem"></a>

#### `event:deliverables/presented.data.files.item`
...
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `sourceEventSeqs` | optional | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `surfaceOp` | required | [`event:assistant/message.surfaceOp`](#persistence-type-eventassistantmessagesurfaceop) |
| `time` | required | `number` |
...
| `message` | required | [`event:developer/message.data.message`](#persistence-type-eventdevelopermessagedatamessage) |
| `step` | required | `number` |
| `turn` | required | `number` |

<a id="persistence-type-eventdevelopermessagedatamessage"></a>

#### `event:developer/message.data.message`
...
| Property | Presence | Type |
|---|---|---|
| `item` | required | [`event:feedback/message-put.data.item`](#persistence-type-eventfeedbackmessage-putdataitem) |
| `sessionId` | required | `string` |

<a id="persistence-type-eventfeedbackmessage-putdataitem"></a>

#### `event:feedback/message-put.data.item`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:feedback/record.data`](#persistence-type-eventfeedbackrecorddata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"feedback/record"` |

<a id="persistence-type-eventfeedbackrecorddata"></a>

#### `event:feedback/record.data`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:goal/change.data`](#persistence-type-eventgoalchangedata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"goal/change"` |

<a id="persistence-type-eventgoalchangedata"></a>

#### `event:goal/change.data`

SHA-256: `7d226b9fd95b4ba213d4237c22e930a91c3c769c95ca7f92977b9d625ba13438`

One of:

- [`event:goal/change.data.variant-0`](#persistence-type-eventgoalchangedatavariant-0)
- [`event:goal/change.data.variant-1`](#persistence-type-eventgoalchangedatavariant-1)

<a id="persistence-type-eventgoalchangedatavariant-0"></a>

#### `event:goal/change.data.variant-0`

SHA-256: `cffcdc19881ab61ec0a9ce18743996f7ac44ac8889f34dfac36ae745574aa22f`

| Property | Presence | Type |
|---|---|---|
| `cleared` | required | [`event:goal/change.data.variant-0.cleared`](#persistence-type-eventgoalchangedatavariant-0cleared) |
| `clearedAt` | required | `number` |
| `kind` | required | `"goal/change"` |
| `operation` | required | `"clear"` |
| `version` | required | `1` |

<a id="persistence-type-eventgoalchangedatavariant-0cleared"></a>

#### `event:goal/change.data.variant-0.cleared`
...
<a id="persistence-type-eventgoalchangedatavariant-1"></a>

#### `event:goal/change.data.variant-1`
...
|---|---|---|
| `createdAt` | required | `number` |
| `goal` | required | [`event:goal/change.data.variant-1.goal`](#persistence-type-eventgoalchangedatavariant-1goal) |
| `kind` | required | `"goal/change"` |
...
<a id="persistence-type-eventgoalchangedatavariant-1goal"></a>

#### `event:goal/change.data.variant-1.goal`

SHA-256: `6bbe793f6a93dc8d50a4d4d3fbb6f8ed15650bcb7e151d28669628f7b7c3fc25`

| Property | Presence | Type |
|---|---|---|
| `blockedReason` | optional | [`event:goal/change.data.variant-1.goal.blockedReason`](#persistence-type-eventgoalchangedatavariant-1goalblockedreason) |
| `id` | required | `string` |
| `maxGoalRounds` | required | `number` |
| `objective` | required | `string` |
| `phase` | required | [`event:goal/change.data.variant-1.goal.phase`](#persistence-type-eventgoalchangedatavariant-1goalphase) |
| `revision` | required | `number` |

<a id="persistence-type-eventgoalchangedatavariant-1goalblockedreason"></a>

#### `event:goal/change.data.variant-1.goal.blockedReason`
...
<a id="persistence-type-eventgoalchangedatavariant-1goalphase"></a>

#### `event:goal/change.data.variant-1.goal.phase`
...
| Property | Presence | Type |
|---|---|---|
| `dialect` | required | [`event:hook/invoked.data.dialect`](#persistence-type-eventhookinvokeddatadialect) |
| `handlerId` | required | `string` |
| `matcher` | optional | `string` |
| `point` | required | `string` |
| `turn` | required | `number` |

<a id="persistence-type-eventhookinvokeddatadialect"></a>

#### `event:hook/invoked.data.dialect`
...
Array of [`event:image/offload.data.targets.item`](#persistence-type-eventimageoffloaddatatargetsitem).

<a id="persistence-type-eventimageoffloaddatatargetsitem"></a>

#### `event:image/offload.data.targets.item`

SHA-256: `1cde1bedde79c5e8a56aee9c05c8e0a579cf5bc611deb85b93fa331a16ca978f`

| Property | Presence | Type |
|---|---|---|
| `imageIndexes` | required | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `seq` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:llm/retry.data`](#persistence-type-eventllmretrydata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:llm/retry-started.data`](#persistence-type-eventllmretry-starteddata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"llm/retry-started"` |

<a id="persistence-type-eventllmretry-starteddata"></a>

#### `event:llm/retry-started.data`
...
<a id="persistence-type-eventllmretrydata"></a>

#### `event:llm/retry.data`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:model/selection.data`](#persistence-type-eventmodelselectiondata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"model/selection"` |

<a id="persistence-type-eventmodelselectiondata"></a>

#### `event:model/selection.data`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:request/context.data`](#persistence-type-eventrequestcontextdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"request/context"` |

<a id="persistence-type-eventrequestcontextdata"></a>

#### `event:request/context.data`
...
| Property | Presence | Type |
|---|---|---|
| `header` | required | [`event:request/header.data.header`](#persistence-type-eventrequestheaderdataheader) |
| `reason` | required | [`event:request/header.data.reason`](#persistence-type-eventrequestheaderdatareason) |
| `startsSeries` | optional | `true` |

<a id="persistence-type-eventrequestheaderdataheader"></a>

#### `event:request/header.data.header`

SHA-256: `9a930283b91d493d6347146f2475bb107294b379415ca02162354f46a64164f7`

| Property | Presence | Type |
|---|---|---|
| `adapterDefaults` | optional | [`event:request/header.data.header.adapterDefaults`](#persistence-type-eventrequestheaderdataheaderadapterdefaults) |
| `config` | required | [`event:request/header.data.header.config`](#persistence-type-eventrequestheaderdataheaderconfig) |
...
<a id="persistence-type-eventrequestheaderdataheaderadapterdefaults"></a>

#### `event:request/header.data.header.adapterDefaults`
...
<a id="persistence-type-eventrequestheaderdataheaderconfig"></a>

#### `event:request/header.data.header.config`
...
Array of [`event:request/header.data.header.tools.item`](#persistence-type-eventrequestheaderdataheadertoolsitem).

<a id="persistence-type-eventrequestheaderdataheadertoolsitem"></a>

#### `event:request/header.data.header.tools.item`
...
<a id="persistence-type-eventrequestheaderdatareason"></a>

#### `event:request/header.data.reason`
...
| Property | Presence | Type |
|---|---|---|
| `mode` | required | [`event:sandbox/mode.data.mode`](#persistence-type-eventsandboxmodedatamode) |
| `source` | optional | `"delegation"` |

<a id="persistence-type-eventsandboxmodedatamode"></a>

#### `event:sandbox/mode.data.mode`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:schedule/change.data`](#persistence-type-eventschedulechangedata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"schedule/change"` |

<a id="persistence-type-eventschedulechangedata"></a>

#### `event:schedule/change.data`

SHA-256: `e1d0e52dcd1855ffb803efc18f8f7b776c48d1c25757e8a75c0281fa298c02e1`

One of:

- [`event:schedule/change.data.variant-0`](#persistence-type-eventschedulechangedatavariant-0)
- [`event:schedule/change.data.variant-1`](#persistence-type-eventschedulechangedatavariant-1)
- [`event:schedule/change.data.variant-2`](#persistence-type-eventschedulechangedatavariant-2)
- [`event:schedule/change.data.variant-3`](#persistence-type-eventschedulechangedatavariant-3)

<a id="persistence-type-eventschedulechangedatavariant-0"></a>

#### `event:schedule/change.data.variant-0`
...
<a id="persistence-type-eventschedulechangedatavariant-1"></a>

#### `event:schedule/change.data.variant-1`
...
<a id="persistence-type-eventschedulechangedatavariant-2"></a>

#### `event:schedule/change.data.variant-2`
...
<a id="persistence-type-eventschedulechangedatavariant-3"></a>

#### `event:schedule/change.data.variant-3`
...
| `schedule` | required | [`event:schedule/change.data.variant-3.schedule`](#persistence-type-eventschedulechangedatavariant-3schedule) |
| `version` | required | `1` |

<a id="persistence-type-eventschedulechangedatavariant-3schedule"></a>

#### `event:schedule/change.data.variant-3.schedule`

SHA-256: `d8f868c6b3e7189de6c1ffe2ea04794ea2aa31315b6347d12536e46020afac87`

One of:

- [`event:schedule/change.data.variant-3.schedule.variant-0`](#persistence-type-eventschedulechangedatavariant-3schedulevariant-0)
- [`event:schedule/change.data.variant-3.schedule.variant-1`](#persistence-type-eventschedulechangedatavariant-3schedulevariant-1)
- [`event:schedule/change.data.variant-3.schedule.variant-2`](#persistence-type-eventschedulechangedatavariant-3schedulevariant-2)

<a id="persistence-type-eventschedulechangedatavariant-3schedulevariant-0"></a>

#### `event:schedule/change.data.variant-3.schedule.variant-0`
...
<a id="persistence-type-eventschedulechangedatavariant-3schedulevariant-1"></a>

#### `event:schedule/change.data.variant-3.schedule.variant-1`
...
<a id="persistence-type-eventschedulechangedatavariant-3schedulevariant-2"></a>

#### `event:schedule/change.data.variant-3.schedule.variant-2`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:session/title.data`](#persistence-type-eventsessiontitledata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:session/title-llm-request.data`](#persistence-type-eventsessiontitle-llm-requestdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"session/title-llm-request"` |

<a id="persistence-type-eventsessiontitle-llm-requestdata"></a>

#### `event:session/title-llm-request.data`
...
| `messageSeqs` | required | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
...
| `route` | required | [`event:session/title.data.source.variant-0.model`](#persistence-type-eventsessiontitledatasourcevariant-0model) |
...
Array of [`event:session/title-llm-request.data.messages.item`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitem).

<a id="persistence-type-eventsessiontitle-llm-requestdatamessagesitem"></a>

#### `event:session/title-llm-request.data.messages.item`

SHA-256: `691c0f641cd3e8072fdacd6fa8c400253cf75a0ce9285d8ce89141bbb24f2fb6`

One of:

- [`event:session/title-llm-request.data.messages.item.variant-0`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-0)
- [`event:developer/message.data.message`](#persistence-type-eventdevelopermessagedatamessage)
- [`event:agent/inbox/spliced.data.inserted.item`](#persistence-type-eventagentinboxspliceddatainserteditem)
- [`event:assistant/message.data.message`](#persistence-type-eventassistantmessagedatamessage)
- [`event:session/title-llm-request.data.messages.item.variant-4`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-4)

<a id="persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-0"></a>

#### `event:session/title-llm-request.data.messages.item.variant-0`
...
| `role` | required | `"tool"` |
| `source` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-80`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-80) |
| `toolCallId` | required | `string` |

<a id="persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-4"></a>

#### `event:session/title-llm-request.data.messages.item.variant-4`
...
| `source` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-69`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-69) |

<a id="persistence-type-eventsessiontitledata"></a>

#### `event:session/title.data`
...
|---|---|---|
| `messageSeqs` | required | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `source` | required | [`event:session/title.data.source`](#persistence-type-eventsessiontitledatasource) |
| `title` | required | `string` |

<a id="persistence-type-eventsessiontitledatasource"></a>

#### `event:session/title.data.source`
...
| `model` | optional | [`event:session/title.data.source.variant-0.model`](#persistence-type-eventsessiontitledatasourcevariant-0model) |
| `provider` | required | `string` |

<a id="persistence-type-eventsessiontitledatasourcevariant-0model"></a>

#### `event:session/title.data.source.variant-0.model`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:subagent/catalog.data`](#persistence-type-eventsubagentcatalogdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"subagent/catalog"` |

<a id="persistence-type-eventsubagentcatalogdata"></a>

#### `event:subagent/catalog.data`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:subagent/descriptor.data`](#persistence-type-eventsubagentdescriptordata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"subagent/descriptor"` |

<a id="persistence-type-eventsubagentdescriptordata"></a>

#### `event:subagent/descriptor.data`

SHA-256: `86d1d0e9cfebb240421187e3dc37fb71cc38a1501885cf32f8f9adef7b0a2bde`

One of:

- [`event:subagent/descriptor.data.variant-0`](#persistence-type-eventsubagentdescriptordatavariant-0)
- [`event:subagent/descriptor.data.variant-1`](#persistence-type-eventsubagentdescriptordatavariant-1)

<a id="persistence-type-eventsubagentdescriptordatavariant-0"></a>

#### `event:subagent/descriptor.data.variant-0`
...
| `provider` | required | `string` |
| `toolFilter` | optional | [`event:subagent/descriptor.data.variant-0.toolFilter`](#persistence-type-eventsubagentdescriptordatavariant-0toolfilter) |
| `version` | required | `number` |

<a id="persistence-type-eventsubagentdescriptordatavariant-0toolfilter"></a>

#### `event:subagent/descriptor.data.variant-0.toolFilter`
...
<a id="persistence-type-eventsubagentdescriptordatavariant-1"></a>

#### `event:subagent/descriptor.data.variant-1`
...
Array of [`event:session/title.data.source.variant-0.model`](#persistence-type-eventsessiontitledatasourcevariant-0model).
...
| Property | Presence | Type |
|---|---|---|
| `message` | required | [`event:session/title-llm-request.data.messages.item.variant-4`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-4) |
| `step` | required | `number` |
| `turn` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `member` | required | [`event:team/member.data.member`](#persistence-type-eventteammemberdatamember) |
| `teamId` | required | `string` |
| `version` | required | `2` |

<a id="persistence-type-eventteammemberdatamember"></a>

#### `event:team/member.data.member`
...
| `id` | required | `string` |
| `name` | required | `string` |
| `phase` | required | [`event:team/member.data.member.phase`](#persistence-type-eventteammemberdatamemberphase) |
| `provider` | required | `string` |
...
<a id="persistence-type-eventteammemberdatamemberphase"></a>

#### `event:team/member.data.member.phase`
...
| Property | Presence | Type |
|---|---|---|
| `message` | required | [`event:team/message/queued.data.message`](#persistence-type-eventteammessagequeueddatamessage) |
| `teamId` | required | `string` |
| `version` | required | `2` |

<a id="persistence-type-eventteammessagequeueddatamessage"></a>

#### `event:team/message/queued.data.message`
...
| Property | Presence | Type |
|---|---|---|
| `task` | required | [`event:team/task.data.task`](#persistence-type-eventteamtaskdatatask) |
| `teamId` | required | `string` |
| `version` | required | `2` |

<a id="persistence-type-eventteamtaskdatatask"></a>

#### `event:team/task.data.task`
...
| `revision` | required | `number` |
| `status` | required | [`event:team/task.data.task.status`](#persistence-type-eventteamtaskdatataskstatus) |
...
<a id="persistence-type-eventteamtaskdatataskstatus"></a>

#### `event:team/task.data.task.status`
...
Array of [`event:todo/write.data.todos.item`](#persistence-type-eventtodowritedatatodositem).

<a id="persistence-type-eventtodowritedatatodositem"></a>

#### `event:todo/write.data.todos.item`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:tool/ptc-dispatch.data`](#persistence-type-eventtoolptc-dispatchdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:tool/ptc-dispatch-start.data`](#persistence-type-eventtoolptc-dispatch-startdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"tool/ptc-dispatch-start"` |

<a id="persistence-type-eventtoolptc-dispatch-startdata"></a>

#### `event:tool/ptc-dispatch-start.data`
...
<a id="persistence-type-eventtoolptc-dispatchdata"></a>

#### `event:tool/ptc-dispatch.data`
...
|---|---|---|
| `error` | optional | [`event:tool/ptc-dispatch.data.error`](#persistence-type-eventtoolptc-dispatchdataerror) |
| `message` | required | [`event:session/title-llm-request.data.messages.item.variant-0`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-0) |
...
| Property | Presence | Type |
|---|---|---|
| `reason` | required | [`event:turn/end.data.reason`](#persistence-type-eventturnenddatareason) |
| `turn` | required | `number` |

<a id="persistence-type-eventturnenddatareason"></a>

#### `event:turn/end.data.reason`
...
| Property | Presence | Type |
|---|---|---|
| `error` | required | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.reason.variant-0.failure`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5reasonvariant-0failure) |
| `kind` | required | `"error"` |
...
|---|---|---|
| `kind` | required | `"aborted"` |
| `reason` | required | [`event:turn/end.data.reason.variant-6.reason`](#persistence-type-eventturnenddatareasonvariant-6reason) |

<a id="persistence-type-eventturnenddatareasonvariant-6reason"></a>

#### `event:turn/end.data.reason.variant-6.reason`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:agent/inbox/spliced.data.inserted.item`](#persistence-type-eventagentinboxspliceddatainserteditem) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `sourceEventSeqs` | optional | [`event:assistant/attempt.data.stream.item.variant-0.dt`](#persistence-type-eventassistantattemptdatastreamitemvariant-0dt) |
| `surfaceOp` | required | [`event:assistant/message.surfaceOp`](#persistence-type-eventassistantmessagesurfaceop) |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:web/deepseek-search-llm-request.data`](#persistence-type-eventwebdeepseek-search-llm-requestdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"web/deepseek-search-llm-request"` |

<a id="persistence-type-eventwebdeepseek-search-llm-requestdata"></a>

#### `event:web/deepseek-search-llm-request.data`
...
| Position | Presence | Type |
|---|---|---|
| 0 | required | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-1`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-1) |
...
The root digests in this snapshot match the accepted V4 finalization checkpoint. `pnpm run verify-persistence-formats` checks the declaration and complete schema offline; it does not replay historical logs or prove migration safety.
