...
export const en = {
  ...
  trayTooltipAgentsRunning: 'DeepSeek Harness — agents are running',
  trayShowWindow: 'Show Window',
  trayHideWindow: 'Hide Window',
  trayQuickPrompt: 'Quick Prompt',
  trayAgentsRunning: 'Agents are running in the background',
  trayQuit: 'Quit DeepSeek Harness',
  quickPromptTitle: 'Quick Prompt',
  quickPromptPlaceholder: 'Ask DeepSeek Harness…',
  quickPromptSend: 'Send',
  quickPromptSending: 'Sending…',
  quickPromptCancel: 'Close',
  quickPromptEmpty: 'Enter a prompt first.',
  quickPromptUnavailable: 'The workspace is not ready. Try again when it finishes starting.',
  quickPromptRejected: 'The prompt was not accepted. Open the workspace and try again.',
  quickPromptShortcut: 'Shortcut',
  quickPromptShortcutChange: 'Change',
  quickPromptShortcutCapturing: 'Press a key combination…',
  quickPromptShortcutInvalid: 'Use a combination with Control, Alt, Command, or Super.',
  quickPromptShortcutConflict: 'Another application already uses that shortcut.',
  quickPromptShortcutUnpersisted: 'The shortcut works now but could not be saved for the next launch.',
  quickPromptShortcutUnavailable: 'The global shortcut {accelerator} is already used by another application. Change it in the quick prompt window, or open the quick prompt from the tray.',
  quickPromptShortcutTitle: 'Global Shortcut Unavailable',
} as const
...
export const zh = {
  ...
  trayTooltip: 'DeepSeek Harness',
  trayTooltipAgentsRunning: 'DeepSeek Harness — 智能体仍在运行',
  trayShowWindow: '显示窗口',
  trayHideWindow: '隐藏窗口',
  trayQuickPrompt: '快速提问',
  trayAgentsRunning: '智能体仍在后台运行',
  trayQuit: '退出 DeepSeek Harness',
  quickPromptTitle: '快速提问',
  quickPromptPlaceholder: '向 DeepSeek Harness 提问…',
  quickPromptSend: '发送',
  quickPromptSending: '正在发送…',
  quickPromptCancel: '关闭',
  quickPromptEmpty: '请先输入提问内容。',
  quickPromptUnavailable: '工作区尚未就绪，请在启动完成后重试。',
  quickPromptRejected: '提问未被接受，请打开工作区后重试。',
  quickPromptShortcut: '快捷键',
  quickPromptShortcutChange: '更改',
  quickPromptShortcutCapturing: '请按下组合键…',
  quickPromptShortcutInvalid: '请使用包含 Control、Alt、Command 或 Super 的组合键。',
  quickPromptShortcutConflict: '该快捷键已被其他应用占用。',
  quickPromptShortcutUnpersisted: '快捷键已生效，但未能保存供下次启动使用。',
  quickPromptShortcutUnavailable: '全局快捷键 {accelerator} 已被其他应用占用。请在快速提问窗口中更改，或从托盘打开快速提问。',
  quickPromptShortcutTitle: '全局快捷键不可用',
