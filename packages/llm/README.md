...
| [`llm-fallback/`](llm-fallback/README.md) | Switches the next attempt to the next healthy configured route when recovery declines, with per-route breaker and key rotation | listens to `agent/request-error` |
