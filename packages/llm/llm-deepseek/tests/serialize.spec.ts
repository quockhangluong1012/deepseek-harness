...
describe('Messages request conversion', () => {
  ...
  it.each(['workspace-memory', 'evolution-review'] as const)('disables thinking for the maintenance purpose %s', (purpose) => {
    const request = body([user()], { purpose, reasoningEffort: ReasoningEffortId('max') })
