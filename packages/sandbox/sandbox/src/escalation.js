 ...
 */
export function assertStandingPolicy(policy) {
    if (policy === undefined) {
        throw new HarnessError('sandbox_permissions is not available for direct calls without a resolved sandbox policy', 'SANDBOX_ESCALATION_UNAVAILABLE');
    }
}
/**
