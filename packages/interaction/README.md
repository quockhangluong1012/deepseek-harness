...
| [`command-inspect/`](command-inspect/README.md) | Reports what the deployment has: the command catalog, environment facts, and the MCP, agent, and hook surfaces | registers on `ctx.commands` |
