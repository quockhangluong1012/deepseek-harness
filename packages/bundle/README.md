...
| [`agent-governance`](agent-governance/README.md) | Opt-in control plane: the agent kernel, its built-in declarations, the criterion verifiers its completion gate delegates to, and the prompt-injection guard | `agentKernel` |
