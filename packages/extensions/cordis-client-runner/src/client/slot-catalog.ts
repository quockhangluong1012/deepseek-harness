...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, kernel-task, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, turn-trigger, unknown, user, workflow-run',
    ...
    occupants: [
      ...
      'client-ui-kernel-task KernelTaskPanel key \'kernel-task\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-evolution EvolutionSeat',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'settings.section\' (client-ui-settings-models), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-authorization SignInCard key \'llm-pi-ai\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-evolution EvolutionPanelIcon',
