 ...
 */
export declare function similarity(left: readonly string[], right: readonly string[]): number;
/**
 ...
 */
export declare function archiveNovelty(features: readonly string[], entries: readonly NoveltyArchiveEntry[]): number;
/**
 ...
 */
export declare function noveltyMean(entries: readonly NoveltyArchiveEntry[]): number;
