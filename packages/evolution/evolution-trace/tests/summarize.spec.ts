          ...
          steps: [
            {
              ...
              calls: [
                { callId: 'c1', name: 'bash', ok: true, errorName: null, errorCode: null, message: null, at: timer },
                { callId: 'c2', name: 'bash', ok: false, errorName: 'bash', errorCode: 'EXIT_1', message: 'boom one', at: timer },
              ],
              failures: 1,
            },
            {
              ...
              calls: [
                { callId: 'c3', name: 'bash', ok: false, errorName: 'bash', errorCode: 'EXIT_1', message: 'boom one', at: timer },
              ],
              failures: 1,
            },
          ],
          ...
          steps: [
            {
              ...
              turn: 1,
              calls: [
                { callId: 'c4', name: 'bash', ok: false, errorName: 'bash', errorCode: 'EXIT_2', message: 'boom two', at: timer },
              ],
              failures: 1,
            },
          ],
      ...
      turns: [{
        ...
        steps: [
          { ...STEP, retries: 2, calls: [
            { callId: 'c1', name: 'bash', ok: false, errorName: null, errorCode: null, message: 'again', at: 't0' },
            { callId: 'c2', name: 'bash', ok: false, errorName: null, errorCode: null, message: 'again', at: 't0' },
          ], failures: 2 },
        ],
        failures: [
