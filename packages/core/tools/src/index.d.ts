 ...
 */
export declare function throwToolAborted(): never;
/**
 ...
 */
export declare function startAbortGuardedBackground<Id extends string>(signal: AbortSignal, start: () => Id, kill: (id: Id) => void): Id;
