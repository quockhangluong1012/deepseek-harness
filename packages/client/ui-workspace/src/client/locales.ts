...
export const zh = {
  ...
  'actions.toggleGroup.aria': '展开或收起“{name}”',
  'actions.openWorkspace.aria': '打开工作区“{name}”',
  'status.running': '进行中',
...
export const en = {
  ...
  'actions.toggleGroup.aria': 'Expand or collapse {name}',
  'actions.openWorkspace.aria': 'Open workspace {name}',
