...
export function ConversationMainPanel(props: ConversationSlotProps) {
  const { sessionId, useSession, useSessions, useConversation, renderSlot, renderFactorySlot, pageOccupied } = props
  ...
  return (
    <div className={css.root} data-phase={phase} data-page-occupied={pageOccupied || undefined}>
