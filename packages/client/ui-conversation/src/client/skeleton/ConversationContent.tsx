...
export function ConversationContent(props: ConversationContentProps) {
  const {
    sessionId, phase, hero, pageOccupied = false, useSession, useSessions, useSessionStatus,
  ...
  // that band from there. Callback ref, not an effect; stable identity prevents
