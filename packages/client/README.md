...
| [`ui-desktop-notifications/`](ui-desktop-notifications/README.md) | Desktop-only OS notifications for turn completions, approvals, questions, and job settlements | — |
