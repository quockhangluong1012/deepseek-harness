...
| [`ui-usage-dashboard/`](ui-usage-dashboard/README.zh.md) | 右侧 Sidebar 用量仪表盘 tab 类型及其 Host 用量台账 Remote | `ctx.usageDashboard` |
...
| [`ui-progress/`](ui-progress/README.zh.md) | 右侧 Sidebar 的任务清单与产出文件列表，在会话首次出现进度时自行打开 | — |
