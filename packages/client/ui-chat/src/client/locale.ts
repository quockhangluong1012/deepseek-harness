...
export const zh = {
  ...
  'rewind.action': '回到此处',
  'rewind.title': '回到第 {turn} 轮',
  'rewind.mode.label': '回退范围',
  'rewind.mode.code': '仅代码',
  'rewind.mode.conversation': '仅对话',
  'rewind.mode.both': '代码和对话',
  'rewind.edit.label': '替换这条消息（可选）',
  'rewind.edit.placeholder': '在分支中改为此内容并重新发送',
  'rewind.effect.code': '把工作区文件恢复到第 {turn} 轮开始时的内容；被替换掉的未提交改动无法找回。',
  'rewind.effect.conversation': '从第 {turn} 轮之前分叉出新会话；当前会话保持不变，分支出现在侧边栏。',
  'rewind.effect.both': '先分叉出新会话，再把工作区文件恢复到第 {turn} 轮开始时的内容；被替换掉的未提交改动无法找回。',
  'rewind.cancel': '取消',
  'rewind.confirm': '确认回退',
...
export const en = {
  ...
  'rewind.title': 'Rewind to turn {turn}',
  'rewind.mode.label': 'What to rewind',
  'rewind.mode.code': 'Code only',
  'rewind.mode.conversation': 'Conversation only',
  'rewind.mode.both': 'Code and conversation',
  'rewind.edit.label': 'Replace this message (optional)',
  'rewind.edit.placeholder': 'Send this instead in the branch',
  'rewind.effect.code': 'Restores working-tree files to their content at the start of turn {turn}; uncommitted content it replaces is gone.',
  'rewind.effect.conversation': 'Branches a new session from just before turn {turn}; this conversation is unchanged and the branch appears in the sidebar.',
  'rewind.effect.both': 'Branches a new session, then restores working-tree files to their content at the start of turn {turn}; uncommitted content it replaces is gone.',
