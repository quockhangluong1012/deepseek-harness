...
| `maxTodos` | `100` | Maximum todos accepted in one whole-list replacement |
| `maxTodoContentChars` | `2000` | Maximum UTF-16 chars accepted per todo content |
