 ...
 */
function usableSkill(definition) {
    const { blueprint } = definition;
    if (blueprint === undefined || isSkillBlueprint(blueprint))
        return definition;
 ...
 */
function isSkillBlueprint(value) {
...
function validateStringArray(value, subject) {
    if (value === undefined)
        return;
...
function validateStringRecord(value, subject) {
    if (value === undefined)
        return;
    if (typeof value !== 'object' || value === null || Array.isArray(value)) {
