...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/evolution/evolution-curator': { kind: 'none', reason: 'Idle-triggered lifecycle transitions over telemetry records; registers no prompt, tool, schema, or result text.' },
