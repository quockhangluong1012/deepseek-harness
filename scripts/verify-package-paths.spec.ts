/**
 * Unit coverage for `verify-package-paths`: the package-group table gate folded
 * into it, and the historical-schema handling that exempts recorded references
...
import { collectPackageGroupTableViolations, findPackagePathViolations } from './verify-package-paths.ts'
