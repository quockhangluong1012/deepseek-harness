...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  caseStore: 'research.md',
  learnerModel: 'research.md',
  misconception: 'research.md',
  mentorLoop: 'research.md',
  ...
  agentKernel: 'agent-kernel.md',
  agentPresets: 'core.md',
  analystProfiles: 'core.md',
  agents: 'core.md',
  ...
  authorizationRemote: 'credentials.md',
  ...
  fs: 'filesystem.md',
  repoIndex: 'filesystem.md',
  goals: 'goal.md',
  inspector: 'extensions.md',
  webServer: 'web-server.md',
  invariants: 'invariants.md',
  llm: 'llm-streaming.md',
  embeddings: 'llm-streaming.md',
  lsp: 'lsp.md',
  ...
  evolutionHeartbeat: 'evolutionary-harness.md',
  evolutionFeedback: 'evolutionary-harness.md',
  evolutionGraph: 'evolutionary-harness.md',
  evolutionDreaming: 'evolutionary-harness.md',
  evolutionController: 'evolutionary-harness.md',
  evolutionTrajectory: 'evolutionary-harness.md',
  evolutionTrace: 'evolutionary-harness.md',
  evolutionCurriculum: 'evolutionary-harness.md',
  evolutionBenchmark: 'evolutionary-harness.md',
  evolutionEvaluatorHealth: 'evolutionary-harness.md',
  evolutionPopulation: 'evolutionary-harness.md',
  evolutionModelRoutes: 'evolutionary-harness.md',
  evolutionCanary: 'evolutionary-harness.md',
  evolutionNovelty: 'evolutionary-harness.md',
  evolutionStagnation: 'evolutionary-harness.md',
  evolutionIslands: 'evolutionary-harness.md',
  evolutionSelfModel: 'evolutionary-harness.md',
  evolutionUncertainty: 'evolutionary-harness.md',
  evolutionAdversary: 'evolutionary-harness.md',
  evolutionLineage: 'evolutionary-harness.md',
  evolutionSleeptime: 'evolutionary-harness.md',
  evolutionBudget: 'evolutionary-harness.md',
  evolutionEvaluatorStrategy: 'evolutionary-harness.md',
  evolutionMeta: 'evolutionary-harness.md',
  evolutionMetrics: 'evolutionary-harness.md',
  evolutionOperators: 'evolutionary-harness.md',
  evolutionCuratorStatus: 'evolutionary-harness.md',
  evolutionScorer: 'evolutionary-harness.md',
  evolutionRetrieval: 'evolutionary-harness.md',
  evolutionVerifiers: 'evolutionary-harness.md',
}
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  mcpServers: 'client-facing Remote serving the Desktop MCP settings page — packages/mcp/mcp-project-config/README.md owns the API',
  acpClient: 'ACP client capabilities and session routing, unreachable from the host-face exports the rendering projection walks — packages/acp/acp/README.md owns the API',
}
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'evolution': 'evolutionary-harness.md',
  'tools': 'tools.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  RoutineId: 'schedule.md',
  RoutineRecord: 'schedule.md',
  RoutineSpec: 'schedule.md',
  ...
  WorkspaceRestoreResult: 'deliverables.md',
  WorkspaceRestoreSkip: 'deliverables.md',
  Reload: 'boot.md',
  PluginInfo: 'boot.md',
  BundleInfo: 'boot.md',
  ...
  McpConnectionStatusChange: 'mcp.md',
  McpServerLayer: 'mcp.md',
  McpServerEndpoint: 'mcp.md',
  McpServerState: 'mcp.md',
  McpServerView: 'mcp.md',
  McpServersView: 'mcp.md',
  McpServerUpsert: 'mcp.md',
  McpServerRemove: 'mcp.md',
  McpMutationRefusal: 'mcp.md',
  McpMutationOutcome: 'mcp.md',
  McpApprovalAsk: 'mcp.md',
  McpApprovalChannel: 'mcp.md',
  McpServersOptions: 'mcp.md',
  Agent: 'core.md',
  AgentCancelCause: 'core.md',
  KernelAttachment: 'agent-kernel.md',
  CompletionDecision: 'agent-kernel.md',
  Checkpoint: 'agent-kernel.md',
  CheckpointReason: 'agent-kernel.md',
  Evidence: 'agent-kernel.md',
  EvidenceInput: 'agent-kernel.md',
  TaskClaim: 'agent-kernel.md',
  TaskClaimInput: 'agent-kernel.md',
  TaskHypothesis: 'agent-kernel.md',
  TaskHypothesisInput: 'agent-kernel.md',
  FailureId: 'agent-kernel.md',
  KernelView: 'agent-kernel.md',
  PlanRevision: 'agent-kernel.md',
  PolicyProfileProvider: 'agent-kernel.md',
  TaskContract: 'agent-kernel.md',
  TaskInput: 'agent-kernel.md',
  CompiledContext: 'agent-context.md',
  CompiledSource: 'agent-context.md',
  ContextCompilationEntry: 'agent-context.md',
  ContextCompilationRecord: 'agent-context.md',
  ContextCompileInput: 'agent-context.md',
  ContextCompiler: 'agent-context.md',
  ContextConflict: 'agent-context.md',
  ContextItem: 'agent-context.md',
  ContextOmission: 'agent-context.md',
  ContextPlacement: 'agent-context.md',
  ContextSource: 'agent-context.md',
  ContextSourceDescriptor: 'agent-context.md',
  ContextSourceKind: 'agent-context.md',
  ContextSourceProvider: 'agent-context.md',
  ContextSourceRegistry: 'agent-context.md',
  OmissionReason: 'agent-context.md',
  RetentionClass: 'agent-context.md',
  ...
  SemanticSessionSearchHit: 'session-query.md',
  ...
  ArtifactDiff: 'spill.md',
  ArtifactExtract: 'spill.md',
  ArtifactMatch: 'spill.md',
  ArtifactSummary: 'spill.md',
  ArtifactText: 'spill.md',
  DiffArtifacts: 'spill.md',
  ExtractArtifact: 'spill.md',
  ReadArtifact: 'spill.md',
  SearchArtifacts: 'spill.md',
  SummarizeArtifact: 'spill.md',
  ...
  CacheHitLowEvent: 'usage-dashboard.md',
  ...
  AuthorizationPromptOptionView: 'credentials.md',
  AuthorizationPromptView: 'credentials.md',
  ...
  AuthorizationStatusView: 'credentials.md',
  ...
  WorkflowCheckpointRef: 'workflow.md',
  WorkflowRunStatus: 'workflow.md',
  WorkflowResumeRequest: 'workflow.md',
  ...
  MentorLoopReport: 'research.md',
  MisconceptionDetection: 'research.md',
  MisconceptionStageChange: 'research.md',
  AdvanceInput: 'research.md',
  ResearchRunRecord: 'research.md',
  ResearchStageProvider: 'research.md',
  ContextTierDemand: 'agent-context.md',
  LlmModelCost: 'llm-streaming.md',
  ObjectJsonSchema: 'tools.md',
}
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WorkspaceMemoryExtraction: 'workspace-memory extraction record is owned by packages/workspace/workspace-memory/README.md',
  ...
  EvolutionExtraction: 'evolution-memory extraction record is owned by packages/evolution/evolution-memory/README.md',
  LessonDecision: 'one extraction pass decision batch is owned by packages/evolution/evolution-memory/README.md',
  EvolutionDecisionsApplied: 'applied decision-batch event payload is owned by packages/evolution/evolution-memory/README.md',
  ...
  LessonMergeStrategy: 'lesson merge policy is owned by packages/evolution/evolution-memory/README.md',
  SweepResult: 'artifact decay sweep outcome is owned by packages/evolution/evolution-memory/README.md',
  ...
  HeartbeatRunOptions: 'heartbeat run options are owned by packages/evolution/evolution-heartbeat/README.md',
  HeartbeatTaskReport: 'heartbeat task report is owned by packages/evolution/evolution-heartbeat/README.md',
  HeartbeatTask: 'heartbeat task registration is owned by packages/evolution/evolution-heartbeat/README.md',
  HeartbeatTaskState: 'heartbeat task state is owned by packages/evolution/evolution-heartbeat/README.md',
  HeartbeatReport: 'heartbeat pass report is owned by packages/evolution/evolution-heartbeat/README.md',
  FeedbackEntry: 'feedback observation is owned by packages/evolution/evolution-feedback/README.md',
  FeedbackSummaryEntry: 'feedback aggregation entry is owned by packages/evolution/evolution-feedback/README.md',
  FeedbackSignal: 'graded feedback signal is owned by packages/evolution/evolution-feedback/README.md',
  FeedbackActionability: 'feedback decisiveness grade is owned by packages/evolution/evolution-feedback/README.md',
  FeedbackEvidenceStatus: 'feedback attribution grade is owned by packages/evolution/evolution-feedback/README.md',
  StructuredReflection: 'structured failure reflection is owned by packages/evolution/evolution-feedback/README.md',
  ReflectionAnalysis: 'reflection analyst fields are owned by packages/evolution/evolution-feedback/README.md',
  ReflectionRecord: 'stored reflection analysis is owned by packages/evolution/evolution-feedback/README.md',
  GraphRecord: 'graph record is owned by packages/evolution/evolution-graph/README.md',
  GraphNode: 'graph node is owned by packages/evolution/evolution-graph/README.md',
  GraphTriple: 'graph triple is owned by packages/evolution/evolution-graph/README.md',
  GraphObserveResult: 'graph observation result is owned by packages/evolution/evolution-graph/README.md',
  GraphAnswer: 'graph relation answer is owned by packages/evolution/evolution-graph/README.md',
  GraphReach: 'graph reached entity is owned by packages/evolution/evolution-graph/README.md',
  GraphExtractResult: 'graph extraction result is owned by packages/evolution/evolution-graph/README.md',
  EmbeddingsProvider: 'embedding provider interface is owned by packages/llm/embeddings/README.md',
  DreamsRecord: 'per-scope dreaming state is owned by packages/evolution/evolution-dreaming/README.md',
  DreamPhase: 'dreaming phase names are owned by packages/evolution/evolution-dreaming/README.md',
  DreamPhaseReport: 'one phase outcome is owned by packages/evolution/evolution-dreaming/README.md',
  DreamReport: 'one cycle outcome is owned by packages/evolution/evolution-dreaming/README.md',
  EmbeddingRequest: 'embedding request shape is owned by packages/llm/embeddings/README.md',
  EmbeddingSpec: 'resolved embedding route and model are owned by packages/llm/embeddings/README.md',
  EmbeddingResult: 'embedding batch result is owned by packages/llm/embeddings/README.md',
  SkillUsageRecord: 'skill usage record is owned by packages/skill/evolution-skill-telemetry/README.md',
  SkillVersion: 'committed body revision is owned by packages/skill/evolution-skill-telemetry/README.md',
  SkillLifecycleState: 'skill lifecycle state is owned by packages/skill/evolution-skill-telemetry/README.md',
  SkillCreatedBy: 'skill creation record is owned by packages/skill/evolution-skill-telemetry/README.md',
  ScoreRequest: 'scorer request input is owned by packages/evolution/evolution-scorer/README.md',
  ScoreOutcome: 'scorer metric triple is owned by packages/evolution/evolution-scorer/README.md',
  EvaluateSkillRequest: 'skill-versus-baseline request is owned by packages/evolution/evolution-scorer/README.md',
  SkillEvaluation: 'skill-versus-baseline verdict is owned by packages/evolution/evolution-scorer/README.md',
  BehaviorEvalRequest: 'behavior evaluation request is owned by packages/evolution/evolution-scorer/README.md',
  BehaviorEvaluation: 'behavior evaluation verdict is owned by packages/evolution/evolution-scorer/README.md',
  ChannelVerdict: 'evaluator channel verdict is owned by packages/evolution/evolution-scorer/README.md',
  DisagreementChannel: 'evaluator channel names are owned by packages/evolution/evolution-scorer/README.md',
  EvaluatorDisagreement: 'evaluator disagreement report is owned by packages/evolution/evolution-scorer/README.md',
  SkillTrustState: 'skill trust standing is owned by packages/skill/evolution-skill-telemetry/README.md',
  SkillTrustFailure: 'attributed skill failure is owned by packages/skill/evolution-skill-telemetry/README.md',
  ...
  RegressionDebt: 'curator regression debt is owned by packages/evolution/evolution-curator/README.md',
  SurveyCandidate: 'curator survey candidate is owned by packages/evolution/evolution-curator/README.md',
  StagedCandidate: 'curator staged candidate is owned by packages/evolution/evolution-curator/README.md',
  StagedSkill: 'curator staged-skill record is owned by packages/evolution/evolution-curator/README.md',
  StageThresholds: 'curator staging thresholds are owned by packages/evolution/evolution-curator/README.md',
  ...
  PendingConsolidation: 'curator pending-consolidation record is owned by packages/evolution/evolution-curator/README.md',
  ...
  TraceRecord: 'structured session trace is owned by packages/evolution/evolution-trace/README.md',
  LearningTraceRow: 'compressed learning-trace row is owned by packages/evolution/evolution-trace/README.md',
  CurriculumGap: 'measured capability gap is owned by packages/evolution/evolution-curriculum/README.md',
  CurriculumProposal: 'staged curriculum task is owned by packages/evolution/evolution-curriculum/README.md',
  CurriculumTaskState: 'curriculum task state is owned by packages/evolution/evolution-curriculum/README.md',
  BenchmarkTask: 'durable evaluation task is owned by packages/evolution/evolution-benchmark/README.md',
  BenchmarkInput: 'benchmark admission input is owned by packages/evolution/evolution-benchmark/README.md',
  BenchmarkState: 'benchmark contamination state is owned by packages/evolution/evolution-benchmark/README.md',
  EvaluatorRun: 'recorded evaluator verdict is owned by packages/evolution/evolution-evaluator-health/README.md',
  EvaluatorRunInput: 'evaluator verdict input is owned by packages/evolution/evolution-evaluator-health/README.md',
  EvaluatorRunStatus: 'evaluator verdict kind is owned by packages/evolution/evolution-evaluator-health/README.md',
  ChannelHealthRow: 'per-channel evaluator health is owned by packages/evolution/evolution-evaluator-health/README.md',
  EvaluatorHealthSummary: 'evaluator health summary is owned by packages/evolution/evolution-evaluator-health/README.md',
  PopulationCandidate: 'population candidate is owned by packages/evolution/evolution-population/README.md',
  PopulationRecordInput: 'population candidate input is owned by packages/evolution/evolution-population/README.md',
  PopulationStatus: 'population candidate status is owned by packages/evolution/evolution-population/README.md',
  PopulationTriple: 'measured population candidate triple is owned by packages/evolution/evolution-population/README.md',
  EvolutionRole: 'evolutionary role is owned by packages/evolution/evolution-model-routes/README.md',
  ModelRoute: 'provider/model route is owned by packages/evolution/evolution-model-routes/README.md',
  RouteOrigin: 'route assignment origin is owned by packages/evolution/evolution-model-routes/README.md',
  RouteRow: 'route assignment is owned by packages/evolution/evolution-model-routes/README.md',
  RouteEvidence: 'route evidence row is owned by packages/evolution/evolution-model-routes/README.md',
  RouteEvidenceInput: 'route evidence input is owned by packages/evolution/evolution-model-routes/README.md',
  RouteSummary: 'per-route evidence summary is owned by packages/evolution/evolution-model-routes/README.md',
  DeploymentState: 'deployment state is owned by packages/evolution/evolution-canary/README.md',
  DeploymentTriple: 'measured deployment triple is owned by packages/evolution/evolution-canary/README.md',
  DeploymentRecord: 'deployment record is owned by packages/evolution/evolution-canary/README.md',
  DeploymentInput: 'deployment input is owned by packages/evolution/evolution-canary/README.md',
  DeploymentSummary: 'deployment summary is owned by packages/evolution/evolution-canary/README.md',
  NoveltyArchiveInput: 'novelty archive input is owned by packages/evolution/evolution-novelty-search/README.md',
  NoveltyArchiveEntry: 'novelty archive entry is owned by packages/evolution/evolution-novelty-search/README.md',
  RunScore: 'measured run triple is owned by packages/evolution/evolution-stagnation/README.md',
  StagnationRun: 'stagnation run is owned by packages/evolution/evolution-stagnation/README.md',
  StagnationRunInput: 'stagnation run input is owned by packages/evolution/evolution-stagnation/README.md',
  StagnationStrategy: 'stagnation strategy is owned by packages/evolution/evolution-stagnation/README.md',
  StagnationStatus: 'stagnation status is owned by packages/evolution/evolution-stagnation/README.md',
  IslandObjective: 'island objective is owned by packages/evolution/evolution-islands/README.md',
  MigrationReason: 'migration reason is owned by packages/evolution/evolution-islands/README.md',
  Island: 'evolution island is owned by packages/evolution/evolution-islands/README.md',
  IslandInput: 'island input is owned by packages/evolution/evolution-islands/README.md',
  Migration: 'island migration is owned by packages/evolution/evolution-islands/README.md',
  MigrationInput: 'island migration input is owned by packages/evolution/evolution-islands/README.md',
  IslandSchedule: 'island schedule row is owned by packages/evolution/evolution-islands/README.md',
  SelfModel: 'self-model is owned by packages/evolution/evolution-self-model/README.md',
  SelfModelInput: 'self-model input is owned by packages/evolution/evolution-self-model/README.md',
  CapabilityObservation: 'capability observation is owned by packages/evolution/evolution-self-model/README.md',
  CapabilityEntry: 'capability entry is owned by packages/evolution/evolution-self-model/README.md',
  FrontierGap: 'frontier gap is owned by packages/evolution/evolution-self-model/README.md',
  UncertaintyKind: 'uncertainty kind is owned by packages/evolution/evolution-uncertainty/README.md',
  UncertaintySignal: 'uncertainty signal is owned by packages/evolution/evolution-uncertainty/README.md',
  UncertaintySignalInput: 'uncertainty signal input is owned by packages/evolution/evolution-uncertainty/README.md',
  EvaluationTask: 'evaluation task is owned by packages/evolution/evolution-uncertainty/README.md',
  AdversarialCategory: 'adversarial category is owned by packages/evolution/evolution-adversary/README.md',
  GamingDefense: 'gaming defense is owned by packages/evolution/evolution-adversary/README.md',
  AdversarialProbe: 'adversarial probe is owned by packages/evolution/evolution-adversary/README.md',
  ProbeInput: 'adversarial probe input is owned by packages/evolution/evolution-adversary/README.md',
  Challenge: 'probing challenge is owned by packages/evolution/evolution-adversary/README.md',
  DefenseStatus: 'defense status is owned by packages/evolution/evolution-adversary/README.md',
  DependencyKey: 'dependency key is owned by packages/evolution/evolution-lineage/README.md',
  DependencyVersions: 'dependency versions are owned by packages/evolution/evolution-lineage/README.md',
  ExperimentOutcome: 'experiment outcome is owned by packages/evolution/evolution-lineage/README.md',
  ExperimentEnvelope: 'experiment envelope is owned by packages/evolution/evolution-lineage/README.md',
  ExperimentInput: 'experiment input is owned by packages/evolution/evolution-lineage/README.md',
  ExperimentComparison: 'experiment comparison is owned by packages/evolution/evolution-lineage/README.md',
  PolicyRevision: 'versioned policy revision is owned by packages/evolution/evolution-lineage/README.md',
  PolicyRevisionInput: 'caller-supplied policy revision is owned by packages/evolution/evolution-lineage/README.md',
  Attribution: 'ablation attribution is owned by packages/evolution/evolution-lineage/README.md',
  AblationResults: 'ablation results are owned by packages/evolution/evolution-lineage/README.md',
  PrecomputeKind: 'precompute kind is owned by packages/evolution/evolution-sleeptime/README.md',
  AnticipatedTask: 'anticipated task is owned by packages/evolution/evolution-sleeptime/README.md',
  AnticipationInput: 'anticipation input is owned by packages/evolution/evolution-sleeptime/README.md',
  PrecomputeArtifact: 'precompute artifact is owned by packages/evolution/evolution-sleeptime/README.md',
  PrecomputeInput: 'precompute input is owned by packages/evolution/evolution-sleeptime/README.md',
  SleeptimeDecision: 'sleeptime decision is owned by packages/evolution/evolution-sleeptime/README.md',
  TaskOccurrence: 'sleeptime occurrence evidence is owned by packages/evolution/evolution-sleeptime/README.md',
  DefenseObservation: 'observed defense state is owned by packages/evolution/evolution-adversary/README.md',
  PoolInput: 'screening-pool input is owned by packages/evolution/evolution-budget/README.md',
  PooledCandidate: 'screening-pool candidate is owned by packages/evolution/evolution-budget/README.md',
  HalvingSchedule: 'successive-halving schedule is owned by packages/evolution/evolution-budget/README.md',
  ObjectiveReading: 'resource-objective reading is owned by packages/evolution/evolution-budget/README.md',
  DreamPromotion: 'durable dream promotion is owned by packages/evolution/evolution-dreaming/README.md',
  DreamLedgerEntry: 'dream ledger entry is owned by packages/evolution/evolution-dreaming/README.md',
  DreamRollbackReport: 'dream rollback report is owned by packages/evolution/evolution-dreaming/README.md',
  RunJudgmentInput: 'caller-supplied run judgment is owned by packages/evolution/evolution-evaluator-health/README.md',
  JudgeCalibration: 'judge calibration reading is owned by packages/evolution/evolution-evaluator-health/README.md',
  Claim: 'durable claim with its evidence and belief is owned by packages/evolution/evolution-graph/README.md',
  ClaimAssertion: 'caller-supplied claim assertion is owned by packages/evolution/evolution-graph/README.md',
  ClaimObserveResult: 'recorded claim batch outcome is owned by packages/evolution/evolution-graph/README.md',
  RecordedRecall: 'recorded recall row is owned by packages/evolution/evolution-memory/README.md',
  MemoryUtility: 'derived memory utility is owned by packages/evolution/evolution-memory/README.md',
  DutyInput: 'caller-supplied duty assignment is owned by packages/evolution/evolution-model-routes/README.md',
  DutyRecord: 'durable duty assignment is owned by packages/evolution/evolution-model-routes/README.md',
  DutyDecision: 'separation-of-duties decision is owned by packages/evolution/evolution-model-routes/README.md',
  DutyVerdict: 'separation-of-duties verdict is owned by packages/evolution/evolution-model-routes/README.md',
  RoleConflict: 'producing/judging role conflict is owned by packages/evolution/evolution-model-routes/README.md',
  InstructionInput: 'caller-supplied mutation instruction is owned by packages/evolution/evolution-operators/README.md',
  InstructionVerdict: 'mutation-instruction verdict is owned by packages/evolution/evolution-operators/README.md',
  OperatorInstruction: 'recorded mutation instruction is owned by packages/evolution/evolution-operators/README.md',
  RetrievalAttributionInput: 'caller-supplied retrieval attribution is owned by packages/evolution/evolution-retrieval/README.md',
  RetrievalAttribution: 'durable retrieval attribution is owned by packages/evolution/evolution-retrieval/README.md',
  RetrievalEffectiveness: 'derived retrieval effectiveness is owned by packages/evolution/evolution-retrieval/README.md',
  RetrievalRankingEntry: 'retrieval ranking entry is owned by packages/evolution/evolution-retrieval/README.md',
  RetrievalTaskClass: 'retrieval task class is owned by packages/evolution/evolution-retrieval/README.md',
  RouteDisagreement: 'route disagreement signal is owned by packages/evolution/evolution-model-routes/README.md',
  SkillUtility: 'derived skill utility is owned by packages/skill/evolution-skill-telemetry/README.md',
  ReplayArtifact: 'caller-supplied replay artifact is owned by packages/evolution/evolution-trace/README.md',
  ReplayReport: 'trace replay report is owned by packages/evolution/evolution-trace/README.md',
  VerifierRequest: 'verifier ladder request is owned by packages/evolution/evolution-verifiers/README.md',
  VerifierVerdict: 'verifier ladder verdict is owned by packages/evolution/evolution-verifiers/README.md',
  CandidateClass: 'candidate class is owned by packages/evolution/evolution-budget/README.md',
  BudgetTaskClass: 'budget task class is owned by packages/evolution/evolution-budget/README.md',
  AllocationInput: 'budget allocation input is owned by packages/evolution/evolution-budget/README.md',
  BudgetAllocation: 'budget allocation is owned by packages/evolution/evolution-budget/README.md',
  SpendInput: 'budget spend input is owned by packages/evolution/evolution-budget/README.md',
  SpendRecord: 'budget spend record is owned by packages/evolution/evolution-budget/README.md',
  BudgetSettlement: 'budget settlement is owned by packages/evolution/evolution-budget/README.md',
  HalvingRound: 'successive-halving round is owned by packages/evolution/evolution-budget/README.md',
  Evaluator: 'evaluator identity is owned by packages/evolution/evolution-evaluator-strategy/README.md',
  TaskClass: 'evaluator task class is owned by packages/evolution/evolution-evaluator-strategy/README.md',
  EvaluatorOutcome: 'evaluator outcome is owned by packages/evolution/evolution-evaluator-strategy/README.md',
  EvaluatorStrategy: 'evaluator strategy is owned by packages/evolution/evolution-evaluator-strategy/README.md',
  StrategyRanking: 'evaluator strategy ranking is owned by packages/evolution/evolution-evaluator-strategy/README.md',
  EngineComponent: 'engine component is owned by packages/evolution/evolution-meta/README.md',
  EngineConfig: 'engine configuration is owned by packages/evolution/evolution-meta/README.md',
  MetaTaskClass: 'meta task class is owned by packages/evolution/evolution-meta/README.md',
  EngineRunInput: 'engine run input is owned by packages/evolution/evolution-meta/README.md',
  EngineRun: 'engine run is owned by packages/evolution/evolution-meta/README.md',
  ConfigSummary: 'engine configuration summary is owned by packages/evolution/evolution-meta/README.md',
  ConfigRecommendation: 'engine configuration recommendation is owned by packages/evolution/evolution-meta/README.md',
  MetricId: 'metric identity is owned by packages/evolution/evolution-metrics/README.md',
  MetricUnit: 'metric unit is owned by packages/evolution/evolution-metrics/README.md',
  MetricValue: 'measured metric is owned by packages/evolution/evolution-metrics/README.md',
  MetricsQuery: 'metric query is owned by packages/evolution/evolution-metrics/README.md',
  MetricsWindow: 'metric run window is owned by packages/evolution/evolution-metrics/README.md',
  MetricsReport: 'metric report is owned by packages/evolution/evolution-metrics/README.md',
  MutationOperator: 'mutation operator is owned by packages/evolution/evolution-operators/README.md',
  ArtifactClass: 'artifact class is owned by packages/evolution/evolution-operators/README.md',
  OperatorOutcome: 'operator outcome is owned by packages/evolution/evolution-operators/README.md',
  OperatorStats: 'operator statistics are owned by packages/evolution/evolution-operators/README.md',
  ...
  LearnerId: 'learner identity is owned by packages/mentor/learner-model/README.md',
  CaseReference: 'case-reference identity is owned by packages/mentor/learner-model/README.md',
  ConceptId: 'concept identity is owned by packages/mentor/learner-model/README.md',
  LearnerRecord: 'durable per-learner record is owned by packages/mentor/learner-model/README.md',
  ConceptAxes: 'concept knowledge and application axes are owned by packages/mentor/learner-model/README.md',
  ConceptEvidence: 'stated concept evidence is owned by packages/mentor/learner-model/README.md',
  ApplicationEvidence: 'graded application evidence is owned by packages/mentor/learner-model/README.md',
  ConfidenceEvidence: 'stated confidence evidence is owned by packages/mentor/learner-model/README.md',
  Misconception: 'recorded learner misconception is owned by packages/mentor/learner-model/README.md',
  MisconceptionEvidence: 'misconception detection evidence is owned by packages/mentor/learner-model/README.md',
  MisconceptionStatus: 'misconception status is owned by packages/mentor/learner-model/README.md',
  MistakeEvidence: 'recurring-mistake evidence is owned by packages/mentor/learner-model/README.md',
  RecurringMistake: 'recurring mistake is owned by packages/mentor/learner-model/README.md',
  LearningObjective: 'next learning objective is owned by packages/mentor/learner-model/README.md',
  ObjectiveInput: 'objective write input is owned by packages/mentor/learner-model/README.md',
  CaseReviewInput: 'case review write input is owned by packages/mentor/learner-model/README.md',
  AdvanceRequest: 'misconception pipeline advance request is owned by packages/mentor/misconception/README.md',
  ThesisInput: 'learner thesis input is owned by packages/mentor/misconception/README.md',
  MisconceptionId: 'misconception occurrence identity is owned by packages/mentor/misconception/README.md',
  MisconceptionPattern: 'catalogue pattern is owned by packages/mentor/misconception/README.md',
  MisconceptionPipeline: 'durable per-learner pipeline is owned by packages/mentor/misconception/README.md',
  MentorDirective: 'mentor directive is owned by packages/mentor/misconception/README.md',
  MentorLoopPosition: 'derived mentor loop position is owned by packages/mentor/mentor-loop/README.md',
  CaseRecord: 'durable per-learner case record is owned by packages/research/case-store/README.md',
  CaseId: 'case identity is owned by packages/research/case-store/README.md',
  CaseOpenInput: 'case open input is owned by packages/research/case-store/README.md',
  CaseAmendment: 'case amendment is owned by packages/research/case-store/README.md',
  LearnerMemoryProjection: 'learner-memory read path is owned by packages/research/case-store/README.md',
  MisconceptionDetectionProjection: 'misconception-detection read path is owned by packages/research/case-store/README.md',
  MentorInterventionProjection: 'mentor-intervention read path is owned by packages/research/case-store/README.md',
  BenchmarkDatasetRow: 'benchmark-dataset read path is owned by packages/research/case-store/README.md',
  CodingQuery: 'coding metric query is owned by packages/evolution/evolution-metrics/README.md',
  CodingReport: 'coding metric report is owned by packages/evolution/evolution-metrics/README.md',
  LongHorizonQuery: 'long-horizon metric query is owned by packages/evolution/evolution-metrics/README.md',
  LongHorizonReport: 'long-horizon metric report is owned by packages/evolution/evolution-metrics/README.md',
  MentorQuery: 'mentor metric query is owned by packages/evolution/evolution-metrics/README.md',
  MentorReport: 'mentor metric report is owned by packages/evolution/evolution-metrics/README.md',
  ResearchQuery: 'research metric query is owned by packages/evolution/evolution-metrics/README.md',
  ResearchReport: 'research metric report is owned by packages/evolution/evolution-metrics/README.md',
  UncertaintyQuery: 'uncertainty metric query is owned by packages/evolution/evolution-metrics/README.md',
  UncertaintyReport: 'uncertainty metric report is owned by packages/evolution/evolution-metrics/README.md',
  SelfModelReport: 'self-model metric report is owned by packages/evolution/evolution-metrics/README.md',
  BenchmarkOutcome: 'recorded benchmark outcome is owned by packages/evolution/evolution-benchmark/README.md',
  BenchmarkRunRequest: 'benchmark run request is owned by packages/evolution/evolution-benchmark/README.md',
  BenchmarkRunReport: 'benchmark run report is owned by packages/evolution/evolution-benchmark/README.md',
  LessonLifecycle: 'lesson lifecycle state is owned by packages/evolution/evolution-memory/README.md',
  MemoryProjection: 'scope memory projection is owned by packages/evolution/evolution-memory/README.md',
  AgentTrace: 'per-agent trace row is owned by packages/evolution/evolution-trace/README.md',
  AnalystProfile: 'declared analyst profile is owned by packages/preset/analyst-profiles/README.md',
  ProfileVerdict: 'profile artifact verdict is owned by packages/preset/analyst-profiles/README.md',
  RepoIndexSnapshot: 'bounded repository snapshot is owned by packages/repo/repo-index/README.md',
  WorkspaceHunkDecision: 'per-hunk apply decision is owned by packages/deliverables/workspace-changes/README.md',
  WorkspaceHunkApplyResult: 'hunk apply outcome is owned by packages/deliverables/workspace-changes/README.md',
  PlanOptions: 'plan revision options are owned by packages/runtime/agent-kernel/README.md',
  UsageSessionCost: 'per-session cost row is owned by packages/session/usage-ledger/README.md',
}
